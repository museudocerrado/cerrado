...
?>
	...
	$comment_form_args = array(
		'fields'	=> apply_filters( 'comment_form_default_fields', array(
			...
			'author' => '<p class="comment-form-author">' . '<label class="assistive-text" for="author">' . __( 'Name &#42;', LANGUAGE_ZONE ) . '</label><input id="author" name="author" type="text" placeholder="' . __( 'Name&#42;', LANGUAGE_ZONE ) . '" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>',
			
			'email' => '<p class="comment-form-email"><label class="assistive-text" for="email">' . __( 'Email &#42;', LANGUAGE_ZONE ) . '</label><input id="email" name="email" type="text" placeholder="' . __( 'Email&#42;', LANGUAGE_ZONE ) . '" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>',
			
			'url' => '<p class="comment-form-url"><label class="assistive-text" for="url">' . __( 'Website', LANGUAGE_ZONE ) . '</label><input id="url" name="url" type="text" placeholder="' . __( 'Website', LANGUAGE_ZONE ) . '" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></p>'
