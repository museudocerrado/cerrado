...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			overlay_gallery_max: 99, /* Maximum number of pictures in the overlay gallery */
		...
		*/
		$.prettyPhoto.close = function(){
			...
			$('div.pp_pic_holder, div.ppt, .pp_fade, .pp_details').fadeOut(settings.animation_speed,function(){ $(this).remove(); });
		...
		*/
		function _showContent(){
			...
			$pp_pic_holder.animate({
				...
				$pp_pic_holder.find('.pp_fade, .pp_details').fadeIn(settings.animation_speed); // Fade the new content
		...
		*/
		function _hideContent(callback){
			...
			$pp_pic_holder.find('.pp_fade, .pp_details').fadeOut(settings.animation_speed,function(){
				$('.pp_loaderIcon').show();
...
*/
			...
			if(isSet && settings.overlay_gallery) {
				...
				$pp_pic_holder.find('.pp_fade').hover( //hoverContainer
					function(e){
				...
				$pp_pic_holder.find('.pp_details').hover(
					/*
function(e) { if (_getFileType(pp_images[set_position])=="image") $pp_pic_holder.find('.pp_gallery').fadeOut(); },
					function(e) { if (_getFileType(pp_images[set_position])=="image") $pp_pic_holder.find('.pp_gallery').fadeOut(); }
*/
				);
