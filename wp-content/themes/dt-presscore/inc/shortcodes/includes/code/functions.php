...
class DT_Shortcode_Code extends DT_Shortcode {
    ...
    public function shortcode_prepare( $atts, $content = null ) {
        ...
        $output = "[dt_code_final]\n\n" . esc_html( str_replace(array('[', ']'), array('%5B', '%5D'), $content ) ) . "[/dt_code_final]";
    ...
    public function shortcode( $atts, $content = null ) {
        ...
        $output = '<div class="shortcode-code">' . force_balance_tags( str_replace( array('%5B', '%5D'), array('[', ']'), $content ) ) . '</div>';
