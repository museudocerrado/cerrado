...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Display Team Members by Category(s)', $translation_content, LANGUAGE_ZONE),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
...
$DT_META_BOXES[] = array(
	...
	'title' 	=> _x('Team Options', $translation_content, LANGUAGE_ZONE),
	'pages' 	=> array( 'page' ),
	'context' 	=> 'normal',
	'priority' 	=> 'high',
	'fields' 	=> array(
		...
		array(
			'name'	=> _x('Number of team members on one page:', $translation_content, LANGUAGE_ZONE),
			'id'    => "{$prefix}ppp",
			'type'  => 'text',
			'std'   => '',
			'top_divider'	=> true
