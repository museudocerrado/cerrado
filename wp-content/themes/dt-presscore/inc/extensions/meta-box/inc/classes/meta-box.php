...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( LANGUAGE_ZONE, RWMB_CSS_URL . 'style.css', array(), RWMB_VER );
				...
				echo '
					...
					if ( typeof rwmb == "undefined" )
					{
						var rwmb = {
							...
							summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', LANGUAGE_ZONE ) . '"
						};
					}
					else
					{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', LANGUAGE_ZONE ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', LANGUAGE_ZONE ) . '</a>';
